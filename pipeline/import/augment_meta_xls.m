%
% AUGMENT_META_XLS    Augment dataset with metadata from an Excel file.
%    
%    META = AUGMENT_META_XLS(DS, XLS) reads patient and sample specific metadata
%    from the Excel spreadsheet file XLS, and associates the metadata with
%    corresponding samples in the pipeline dataset DS.
%
%    See HELP AUGMENT_META_TAB for more information and a list of supported
%    column names in the spreadsheet.

% Author: Matti Annala <matti.annala@tut.fi>

function metadata = augment_meta_xls(dataset, filepath, varargin)
