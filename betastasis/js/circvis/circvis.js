    ...
    switch (dataObj._wedge[index]._plot_type) {
        ...
        case 'karyotype':
            panel_layer.add(pv.Wedge)   //karyotype
                ...
                //.strokeStyle( function(d) {return d[value_key];})
                .cursor('pointer')
                .event('click',function(c,d){ dataObj._wedge[index].listener(c);} )
                .event('mouseover',behavior);
            break;
   ...
   if(dataObj._plot.legend_show_rings) {
       rings.add(pv.Wedge)
        ...
        .angle(Math.PI * 2)
			...
			var lring = dataObj._wedge[c]
			if (lring._legend_desc == "markers")
				return "red";//lring._fillStyle();
			if (lring._legend_desc == "hotspots")
				return "green";
			return "blue";
		})
...
vq.models.CircVisData.prototype.setDataModel = function() {
 this._dataModel = [
    ...
    {label : '_plot.legend_radius', id: 'PLOT.legend_radius', cast: Number, defaultValue : 25 },
     {label : '_plot.legend_show_rings', id: 'PLOT.legend_show_rings', cast: Boolean, defaultValue : false },
    {label : '_plot.rotate_degrees', id: 'PLOT.rotate_degrees', cast: Number, defaultValue : 0 },
     {label : '_plot.tooltip_timeout', id: 'PLOT.tooltip_timeout', cast: Number, defaultValue : 100 },
    ...
    {label : '_network.min_node_linkDegree', id: 'NETWORK.OPTIONS.min_node_linkdegree', cast : Number, defaultValue :  0 },
         {label : '_network.node_overlap_distance', id: 'NETWORK.OPTIONS.node_overlap_distance', cast : Number, defaultValue :  12000.0},
